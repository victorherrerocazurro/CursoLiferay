...
VALUES (1,1,'activa','2015-05-20 00:00:00','2015-05-21 00:00:00');
INSERT INTO SUBASTAS (SUBASTAS.ID_PRODUCTO,SUBASTAS.ID_SUBASTADOR,SUBASTAS.ESTADO,SUBASTAS.FECHA_INICIO,SUBASTAS.FECHA_FIN) 
VALUES (2,1,'activa','2015-05-20 00:00:00','2015-05-21 00:00:00');
INSERT INTO SUBASTAS (SUBASTAS.ID_PRODUCTO,SUBASTAS.ID_SUBASTADOR,SUBASTAS.ESTADO,SUBASTAS.FECHA_INICIO,SUBASTAS.FECHA_FIN) 
VALUES (3,1,'activa','2015-05-20 00:00:00','2015-05-21 00:00:00');
INSERT INTO SUBASTAS (SUBASTAS.ID_PRODUCTO,SUBASTAS.ID_SUBASTADOR,SUBASTAS.ESTADO,SUBASTAS.FECHA_INICIO,SUBASTAS.FECHA_FIN) 
VALUES (4,2,'activa','2015-05-20 00:00:00','2015-05-21 00:00:00');

INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(1,1,12.3,'2015-05-20 00:00:00','superada');
INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(1,2,15.5,'2015-05-20 00:00:00','superada');
INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(1,3,16.7,'2015-05-20 00:00:00','maxima');

INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(2,3,6.2,'2015-05-20 00:00:00','superada');
INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(2,2,7.2,'2015-05-20 00:00:00','superada');
INSERT INTO PUJAS (PUJAS.ID_SUBASTA,PUJAS.ID_PUJADOR,PUJAS.PUJA,PUJAS.FECHA,PUJAS.ESTADO)
VALUES(2,3,8.2,'2015-05-20 00:00:00','maxima');
...
SELECT P.NOMBRE, P.DESCRIPCION, S.ESTADO, S.FECHA_INICIO, S.FECHA_FIN FROM SUBASTAS AS S 
INNER JOIN PRODUCTOS AS P ON S.ID_PRODUCTO = P.ID 
WHERE S.ID_SUBASTADOR = 20199;

--CONSULTA DE SUBASTAS POR USUARIO
SELECT distinct P.NOMBRE, P.DESCRIPCION, S.ESTADO, S.FECHA_INICIO, S.FECHA_FIN, PJ.PUJA FROM SUBASTAS AS S 
INNER JOIN PRODUCTOS AS P ON S.ID_PRODUCTO = P.ID
LEFT JOIN PUJAS AS PJ ON S.ID = PJ.ID_SUBASTA 
WHERE S.ID_SUBASTADOR = 20199
AND PJ.ESTADO = 'maxima';
...
--Puja MAxima
SELECT max(puja) FROM PUJAS INNER JOIN SUBASTAS ON PUJAS.ID_SUBASTA = SUBASTAS.ID
