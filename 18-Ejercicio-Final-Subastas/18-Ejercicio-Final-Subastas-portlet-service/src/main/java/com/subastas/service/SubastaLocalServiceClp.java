...
public class SubastaLocalServiceClp implements SubastaLocalService {
    ...
    public SubastaLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "buscarSubastasPorPujador";
    ...
    public com.subastas.model.Subasta addSubasta(
        ...
        return (com.subastas.model.Subasta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.subastas.model.Subasta> getSubastas(int start,
        ...
        return (java.util.List<com.subastas.model.Subasta>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.subastas.model.Subasta> buscarSubastasPorPujador(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { pujadorId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
